      ...
      <div className="relative w-full max-w-md">
        <div className="bg-slate-800/80 backdrop-blur-xl rounded-2xl shadow-2xl border border-slate-700 p-8 animate-slideUp">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-start">
              <input
                ...
                id="terms"
                required
                className="mt-1 w-4 h-4 border-slate-700 bg-slate-900 rounded focus:ring-primary-500 text-primary-500"
              />
          ...
          <div className="my-6 flex items-center">
            ...
            <span className="px-3 text-sm text-slate-500">Already have an account?</span>
            <div className="flex-1 border-t border-slate-700" />
          </div>
